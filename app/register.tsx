...
const register = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <TextInput style={[styles.input, {borderColor: inputBorderColor, color: inputBorderColor}]} placeholder="Juan" placeholderTextColor={Colors.light.gray} />

            <ThemedText style={[styles.inputLabel]}>Apellido</ThemedText>
            <TextInput style={[styles.input, {borderColor: inputBorderColor, color: inputBorderColor}]} placeholder="Torres" placeholderTextColor={Colors.light.gray} />
